(function ($) {
            ...
            contactForm.validator().on('submit', function (e) {
                ...
                if (e.isDefaultPrevented()) {
                    ...
                    $.ajax({
                        ...
                        dataType: "json",
                        beforeSend: function () {
                            $target.html("<div class='alert alert-info'><p>Verzenden ...</p></div>");
                        },
                        success: function (response) {
                            console.log(response);
                            if (response.ok) {
                                $this[0].reset();
                                $target.html("<div class='alert alert-success'><p>Uw bericht werd succesvol verzonden. We nemen zo snel mogelijk contact met u op!</p></div>");
                            } else {
                                $target.html("<div class='alert alert-success'><p>Er is iets foutgelopen!</p></div>");
                            }
                        },
    ...
    if ($.fn.meanmenu) {
        $('nav#dropdown').meanmenu({
            siteLogo: "<div class='mobile-menu-nav-back'><a class='logo-mobile' href='contact'><img src='img/logo-mobile-white.png' alt='logo' class='img-fluid'/></a><a class='mobile-contact' href='contact'>CONTACT</a></div>"
        });
    }
    ...
    if ($("#googleMap").length) {
        window.onload = function () {
            ...
            var options = {
                ...
                center: new google.maps.LatLng(51.0813132,3.1056188),
                zoom: 15,
